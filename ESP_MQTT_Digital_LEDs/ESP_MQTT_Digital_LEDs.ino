...
/**************************** FOR OTA **************************************************/
#define SENSORNAME "Christmas_Tree_Small_ESP" //change this to whatever you want to call your device
...
const char* light_state_topic = "whit33r/strip_test";
const char* light_set_topic = "whit33r/strip_test/set";
...
void setup() {
  ...
  WiFi.hostname("Christmas_Tree_Small_ESP");
  //OTA SETUP
